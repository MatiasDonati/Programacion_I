...
def obtener_nombre_usuario(ventana_ppal, fondo_intro, fuente):
    nombre = ""
    input_activo = True
    ingreso_enter = False
    ...
    while input_activo:
        ...
        texto_superficie_2 = fuente.render("Ingresa tu nombre y presiona Enter:",True, constantes.NEGRO)
        texto_rect_2 = texto_superficie_2.get_rect()

        texto_superficie_3 = fuente.render(nombre,True, constantes.NEGRO)
        texto_rect_3  =texto_superficie_3.get_rect()
